...
echo     - Repository name:  love-web-studios
echo     - Choose:           Public
...
git remote add origin https://github.com/genXplatinum/love-web-studios.git
git branch -M main
...
echo     1) Open: https://github.com/genXplatinum/love-web-studios
...
echo     https://genXplatinum.github.io/love-web-studios/
echo ================================================================
goto end
...
echo   named exactly   love-web-studios   (don't add any files),
